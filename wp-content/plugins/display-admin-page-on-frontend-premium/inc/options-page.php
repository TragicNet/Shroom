		...
		function render_troubleshooting_tab_content() {
			...
			<div class="troubleshooting tab-content">
				...
				<div class="wpfa-support-data" style="display: none;">
					...
					//var_dump('$loose_url', VG_Admin_To_Frontend_Obj()->prepare_loose_url('http://wpplugins.local/frontend-admin/wp-admin/edit.php?s=&post_status=all&post_type=page&_wpnonce=dada9fa250&_wp_http_referer=%2Fmyshoppe%2Fwp-admin%2Fedit.php%3Fpost_type%3Dpage%26vgfa_source%3D949&action=trash&m=0&paged=1&post%5B%5D=163&action2=trash'));
					?>
				</div>
			</div>
			<?php
